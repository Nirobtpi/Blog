        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <h5 class="card-title">All Deleted News</h5>
                    ...
                    <table class="table table-bordered border-primary">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('/admin/deleted-news-restore') }}/{{ $news->id  }}" class="btn btn-sm btn-outline-info d-block mb-1">Restore</a>&nbsp;&nbsp;
                                    <a href="{{ url('/admin/force-deleted-news') }}/{{ $news->id }}"
                                    class="btn btn-sm btn-outline-danger d-block">delete</a>
                                </td>
                            </tr>
                            @endforeach
